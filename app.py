...
start_day_str = '20231228'
last_day_str = '20241231'
...
#Método para fazer a requisição da pesquisa e retornar como utf-8 e csv
def to_df(queryurl):
...
app.layout = dbc.Container(
  [
    dbc.Row([ #row 1
      dbc.Col([html.H1('US National Television New Coverage of the War in Ukraine')],
        className="text-center mt-3 mb-1"    
        )
      ]),
    dbc.Row([ #row 2
      dbc.Label("Select a date range:", className="fw_bold")
      ]),
